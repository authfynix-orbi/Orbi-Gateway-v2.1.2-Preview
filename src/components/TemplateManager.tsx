    ...
    <div className="p-4 sm:p-8 max-w-7xl mx-auto space-y-6">
      ...
      {isModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm overflow-y-auto">
          <div className="enterprise-card w-full max-w-6xl shadow-2xl overflow-hidden animate-in fade-in zoom-in duration-300 flex flex-col md:flex-row h-auto max-h-[95vh]">
            
            {/* Left Side: Form (Increased Room) */}
            <div className="flex-[1.2] p-6 sm:p-8 space-y-6 overflow-y-auto border-r border-slate-100">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-slate-500 text-[11px] font-medium">
                    {editingTemplateId ? 'Update your existing communication preset.' : 'Design your next communication preset.'}
                  </p>
                </div>
                <button
              ...
              <form onSubmit={handleAddTemplate} className="space-y-5">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="space-y-1.5">
                    <label className="text-[10px] font-black uppercase tracking-widest text-slate-400 ml-1">Message Type</label>
                    <select
                  ...
                  <div className="space-y-1.5">
                    <label className="text-[10px] font-black uppercase tracking-widest text-slate-400 ml-1">Communication Channel</label>
                    <div className="grid grid-cols-4 gap-2">
                      {(['sms', 'whatsapp', 'email', 'push'] as const).map((type) => (
                        <button
                          ...
                          className={`group flex flex-col items-center justify-center gap-1.5 p-2 rounded-xl border transition-all relative overflow-hidden ${
                            newChannel === type 
                              ? 'bg-indigo-600 border-indigo-600 text-white shadow-md shadow-indigo-100' 
                              : 'bg-slate-50 border-slate-200 text-slate-500 hover:bg-slate-100'
                          }`}
                        >
                          <div className={`p-1.5 rounded-lg transition-colors ${newChannel === type ? 'bg-white/20' : 'bg-white shadow-sm'}`}>
                ...
                {newChannel === 'email' && (
                  ...
                  <div className="space-y-1.5">
                    <div className="flex justify-between items-center ml-1">
                      <div className="flex flex-col">
                        ...
                        <p className="text-[9px] text-indigo-500 font-bold">Use {"{{variable}}"} for dynamic data</p>
                      </div>
                      ...
                      {[
                        ...
                        <button 
                          ...
                          className="text-[8px] px-2 py-0.5 bg-slate-100 hover:bg-indigo-100 hover:text-indigo-600 text-slate-500 rounded-md font-bold uppercase tracking-tighter transition-colors border border-slate-200"
                        >
                          + {v.tag}
                        </button>
                      ))}
                  ...
                  <div className="relative">
                    <textarea
                      ...
                      rows={4}
                      className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl focus:bg-white focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/5 transition-all text-sm font-medium resize-none leading-relaxed shadow-sm"
                    />
                    <div className="absolute bottom-3 right-3 px-1.5 py-0.5 bg-white/80 backdrop-blur-sm rounded-md border border-slate-100 shadow-sm">
                      <span className={`text-[9px] font-black ${newBody.length > 160 ? 'text-amber-500' : 'text-slate-400'}`}>
                        {newBody.length} / 160
                      </span>
                    </div>
                  </div>
                ...
                <div className="pt-2 flex gap-3">
                  <button
                    type="button"
                    onClick={() => setIsModalOpen(false)}
                    className="flex-1 px-6 py-2.5 rounded-xl font-black text-slate-500 hover:bg-slate-100 transition-all text-[10px] uppercase tracking-widest border border-slate-200"
                  >
                    Discard
                  </button>
                  <button
                    ...
                    className="flex-[2] bg-slate-900 hover:bg-black disabled:opacity-50 text-white px-6 py-2.5 rounded-xl font-black transition-all shadow-lg shadow-slate-200 active:scale-[0.98] text-[10px] uppercase tracking-widest"
                  >
            ...
            <div className="hidden md:flex flex-[0.8] bg-slate-50 p-8 items-center justify-center relative">
              <button
                onClick={() => setIsModalOpen(false)}
              ...
              <div className="w-full max-w-[260px] space-y-6">
                <p className="text-center text-[10px] font-black text-slate-400 uppercase tracking-[0.3em]">Live Preview</p>
